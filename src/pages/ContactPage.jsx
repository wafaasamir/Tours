      ...
      <main>
        <section class="contact position-relative container-fluid p-0">
          <img
            ...
            class="w-100 h-100"
          />
          <h1 class="position-absolute text-center text-uppercase">
            contact us
          </h1>
          ...
          <div class="row my-5">
            <div class="col-md-6 me-5">
              <form id="contact-form" class="contact-form">
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <div
                      ...
                      class="error text-danger mt-2 ps-2"
                    ></div>
                  </div>
                  <div class="col-md-6 mb-3">
                    <input
                ...
                <button
                  type="submit"
                  class="btn send-message-btn py-4 px-5 mb-5"
                >
                  Send Message
                </button>
              </form>
