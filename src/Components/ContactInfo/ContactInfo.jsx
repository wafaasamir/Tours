...
function ContactInfo() {
  return (
    <>
      <div className="info-section d-flex align-items-start my-3">
        ...
        <div>
          <h4 className="info-title mb-1">Hours</h4>
          <p className="info-details mb-0">
      ...
      <div className="info-section d-flex align-items-start my-3">
        ...
        <div>
          <h4 className="info-title mb-1">Call Us:</h4>
          <p className="info-details mb-0">
      ...
      <div className="info-section d-flex align-items-start my-3">
        ...
        <div>
          <h4 className="info-title mb-1">Location</h4>
          <p className="info-details mb-0">
            North Virgil Way,<br />
            Florence, 89732
          </p>
